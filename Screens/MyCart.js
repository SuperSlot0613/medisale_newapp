...
const MyCart = ({ navigation }) => {
  ...
  const getTotal = (productData) => {
    ...
    console.log("This is basket total", total);
    setTotal(total);
  };
        ...
        >
          <View style={{}}>
            ...
            >
              ...
              <Text>
                (~&#8377;
                {parseInt(data.price) + data.price / 20})
              </Text>
            </View>
          </View>
          <View
          ...
          >
            ...
            >
              <TouchableOpacity
                onPress={() => dispatch(DECREASE_ITEM_QUANTITY(data.id))}
              >
                <View
                  style={{
                    borderRadius: 100,
              ...
              <TouchableOpacity
                onPress={() => dispatch(INCREASE_ITEM_QUANTITY(data.id))}
              >
                <View
                  style={{
                    borderRadius: 100,
