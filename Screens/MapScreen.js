...
const MapScreen = () => {
  ...
  // console.log("This is Markers", distancedata);
  ...
  // console.log(visible);
  // console.log("This is user Location",userloc);
  ...
  const onMarkerPress = (mapEventData) => {
    ...
    // console.log("This is markerId",markerID)
    ...
    console.log("This is scroll view", _scrollView.current);
  };
              ...
              <View style={styles.button}>
                <Button
                  ...
                  onPress={() => {
                    ...
                    navigation.navigate("MapViwDirections");
                  }}
                >
                  Order
                </Button>
